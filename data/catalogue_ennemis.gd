...
static func _construire() -> Dictionary:
	var tous := {
		"encrier_rampant": {
			"nom": "Encrier rampant",
			"pv": 42.0, "vitesse": 180.0, "degats": 19.0, "portee": 60.0,
		...
		"plume_sentinelle": {
			...
			"pv": 28.0, "vitesse": 0.0, "degats": 26.0, "portee": 2100.0,
		...
		"tache_veloce": {
			"nom": "Tache véloce",
			"pv": 24.0, "vitesse": 640.0, "degats": 22.0, "portee": 70.0,
		...
		"scribe_essaimeur": {
			...
			"pv": 68.0, "vitesse": 205.0, "degats": 24.0, "portee": 500.0,
		...
		"marge_harceleuse": {
			...
			"pv": 38.0, "vitesse": 320.0, "degats": 28.0, "portee": 620.0,
		...
		"miroir_encre": {
			"nom": "Miroir d’encre",
			"pv": 100.0, "vitesse": 190.0, "degats": 33.0, "portee": 520.0,
		...
		"cachet_phaseur": {
			"nom": "Cachet phaseur",
			"pv": 44.0, "vitesse": 255.0, "degats": 30.0, "portee": 470.0,
		...
		"fuseau_tisseur": {
			"nom": "Fuseau tisseur",
			"pv": 90.0, "vitesse": 260.0, "degats": 29.0, "portee": 560.0,
		...
		"fiole_volatile": {
			"nom": "Fiole volatile",
			"pv": 30.0, "vitesse": 225.0, "degats": 24.0, "portee": 205.0,
