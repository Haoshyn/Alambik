...
# Le projectile est un equipement de comportement, pas une nouvelle arme. Les
# visuels restent identiques pour l'instant ; seul le Tir produit est transforme.
const TYPES := {
	"standard": {
		"nom": "Orbe équilibré",
	...
	"veloce": {
		"nom": "Orbe véloce",
		"description": "Très rapide et plus précis, légèrement moins puissant.",
		"niveau": 4,
		"degats_mult": 0.95,
		"vitesse_mult": 1.55,
		"portee_mult": 1.10,
