...
- Petit mage humain violet : robe simple, mains et tête humaines, grand chapeau masquant le visage à la caméra de jeu, écharpe et baguette. Matériaux unis, quatorze os et six animations ; source de géométrie `tools/blender/mage_arcade.py`, outils et rig dans `mage_manga.py`. Direction visuelle en attente de validation du propriétaire. Bilan : `docs/ops/RETOUCHES_GRAPHIQUES.md`.
